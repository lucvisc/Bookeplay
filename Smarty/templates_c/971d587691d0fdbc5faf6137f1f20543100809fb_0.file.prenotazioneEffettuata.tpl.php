<?php
/* Smarty version 3.1.33, created on 2019-09-01 14:58:04
  from 'C:\xampp\htdocs\BookAndPlay\Smarty\template\prenotazioneEffettuata.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d6bc05cb11b06_54290558',
...
function content_5d6bc05cb11b06_54290558 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
"  alt="profile picture" /></div>
    ...
    <div class="container">
      <div class="row" style="">
        ...
        <div class="col-md-8 col-8 border border-light rounded" style="background-image: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.8)); background-position: left top; background-size: 100%; background-repeat: repeat;">
          <div class="tab-content">
            </div>
          </div>
          <h2 class="ml-5 text-light border-dark border border-bottom" style="">Prenotazione Effettuata:</h2>
          <div class="row">
            <div class="col-md-12" style="">
