    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3" style="">
          ...
          <a class="btn btn-block btn-info" href="/BookAndPlay/Admin/partite">Crea/Cancella </a><a class="btn btn-block btn-info" href="/BookAndPlay/Admin/modifica">Modifica Partita</a>
      ...
      <div class="row">
        <div class="col-lg-3 col-6 p-3">
          ...
          <ul class="list-unstyled">
            ...
            <li> <a href="/BookAndPlay/Admin/partite">Crea/Cancella</a></li><a href="/BookAndPlay/Admin/partite">
            </a>
            <li><a href="/BookAndPlay/Admin/partite"> </a><a href="/BookAndPlay/Admin/modifica">Modifica Partita</a></li>
