    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-9 col-md-8" style=" background-image: linear-gradient(to bottom, rgba(0,0,0,0.2), rgba(0,0,0,0.8)); background-position: top left;  background-size: 100%;  background-repeat: repeat;">
            ...
            <div class="col-md-12" style="">
              <div class="form-group row m-2" style="">
                ...
                <div class="col-md-6" style="">
                  <form action="/BookAndPlay/Admin/giornoPartita" method="POST" class="form-inline" style="">
                    <div class="input-group">
                      <input type="date" name="giorno" class="form-control" id="inlineFormInputGroup" placeholder="Search" style="" required="required"><div class="input-group-append"><button class="btn btn-info" type="button"><i class="fa fa-search" aria-hidden="true"></i></button></div>
                    </div>
                  </form>
                </div>
              </div>
          ...
          <form action="/BookAndPlay/Admin/modificaPartita" method="POST">
          <div class="row">
            <div class="col-md-10 shadow-none text-center  offset-md-1" style="">
              <div class="form-group row m-2" style="">
                ...
                <div class="col-md-5 offset-md-1" style="">
                    <div class="input-group">
                      <input type="number" name="old_fascia_oraria" class="form-control" id="inlineFormInputGroup" placeholder="--/--:--/--" style="" required="required">
                    </div>
                </div>
                </div>
            </div>
            <div class="col-md-10 shadow-none text-center  offset-md-1" style="">
              <div class="form-group row m-2" style="">
                ...
                <div class="col-md-5 offset-md-1" style="">
                    <div class="input-group">
                      <input type="number" name="new_fascia_oraria" class="form-control" id="inlineFormInputGroup" placeholder="--/--:--/--" style="" required="required">
                    </div>
                </div>
                </div>
            </div>
