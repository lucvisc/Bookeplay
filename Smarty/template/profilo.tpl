        ...
        <div class="col-9 col-md-8" style="	background-image: linear-gradient(to bottom, rgba(0,0,0,0.2), rgba(0,0,0,0.8));	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
          ...
          <div class="row">
            <div class="col-md-12" style="">
              <div class="row" style="">
                <div class="col-md-5 border-left border-top border-bottom border-light rounded " style="">
                  <h4 class="ml-5 text-light">Username:</h4>
                  <h4 class="ml-5 text-light" style="">Email:</h4>
                  <h4 class="ml-5 text-light" style="">Telefono:</h4>
                  <h4 class="ml-5 text-light" style="">Data di nascita:</h4>
                  <h4 class="ml-5 text-light" style="" contenteditable="true">Sesso:</h4>
                </div>
                <div class="col-md-5 col-lg-6 border-bottom border-top border-right border-light rounded" style="">
                  <h4 class="text-light">{$username}</h4>
                  <h4 class="text-light">{$email}</h4>
                  <h4 class="text-light">{$telefono}</h4>
                  <h4 class="text-light">{$datanascita}</h4>
                  <h4 class="text-light" contenteditable="true">{$sesso}</h4>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 shadow-none text-center " style=""><a class="btn btn-primary active my-2" href="modificaProfilo.html">Modifica profilo</a></div>
          </div>
        </div>
      </div>
    </div>
