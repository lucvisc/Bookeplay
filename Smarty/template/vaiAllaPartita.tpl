...
<body style="	background-image: url(img/sfondo_2.jpg);	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container"> <button class="navbar-toggler navbar-toggler-right border-0" type="button" data-toggle="collapse" data-target="#navbar12">
      ...
      <div class="collapse navbar-collapse" id="navbar12"> <a class="navbar-brand d-none d-md-block" href="#">
          <i class="fa d-inline fa-lg fa-circle" aria-hidden="true"></i>
  ...
  <div class="py-5" style="">
    ...
    <div class="container">
      <div class="row" style="">
        <div class="col-md-3" style=""><a class="btn btn-block btn-info" href="profilo.html"><i class="fa fa-user fa-fw"></i>Profilo</a><a class="btn btn-block btn-info" href="profilo.html"><i class="fa fa-calendar-plus-o">Crea/Partecipa</i></a><a class="btn btn-block btn-info" href="riepilogo.html">Riepilogo</a></div>
                                ...
                                <h3 class="text-light m-0" style="">
                                  <div class="row">
                                    <div class="border-light border-top border-bottom border-left my-2 ml-2" style="">
                                      ...
                                      <h4 class="ml-5 text-light">Quota:</h4>
                                      <h4 class="ml-5 text-light">Livello:</h4>
                                      <h4 class="ml-5 text-light" contenteditable="true">Note:</h4>
                                    </div>
                                    <div class="col-md-4 col-lg-6 border-top border-bottom border-right border-light my-2 mr-2" style="">
