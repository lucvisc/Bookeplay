...
<head>
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <link rel="icon" href="/BookAndPlay/Smarty/template/img/favicon.png">
    ...
    <link href="/BookAndPlay/Smarty/template/css/error.css" rel="stylesheet">
</head>
...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    ...
    <main role="main" class="inner cover">
        <img src="/BookAndPlay/Smarty/template/img/favicon.png" width="400" height="300"/>
