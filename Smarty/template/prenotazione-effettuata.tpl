  ...
  <div class="py-5 h-100" style="">
    ...
    <div class="container">
      <div class="row" style="">
        ...
        <div class="col-md-7 col-8 border border-light rounded" style="	background-image: linear-gradient(to bottom, rgba(0,0,0,0.2), rgba(0,0,0,0.8));	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
          ...
          <h2 class="ml-5 text-light border-dark border border-bottom" style="" contenteditable="true">Riepilogo della prenotazione:</h2>
          <div class="row">
            <div class="col-md-12" style="">
              <div class="row">
                <div class="col-md-6 border-dark" style="">
                  <h4 class="ml-5 text-light">Giorno:</h4>
                  <h4 class="ml-5 text-light" style="">FasciaOraria:</h4>
                  <h4 class="ml-5 text-light" style="">Livello:</h4>
                  <h4 class="ml-5 text-light" style="">Numero Giocatori:</h4>
                  <h4 class="ml-5 text-light" style="">Quota:</h4>
                  <h4 class="ml-5 text-light" style="">Note:</h4>
                </div>
                <div class="col-lg-6 border-dark col-md-6 " style="">
                  <h4 class="text-light">{$giorno}</h4>
                  <h4 class="text-light">{$fasciaoraria}</h4>
                  <h4 class="text-light">{$livello}</h4>
                  <h4 class="text-light">{$numerogiocatori}</h4>
                  <h4 class="text-light">{$quota}</h4>
