            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-11 col-lg-12 rounded" style="	background-image: linear-gradient(to bottom, rgba(0,0,0,0.2), rgba(0,0,0,0.8));	background-position: top left;	background-size: 100%;	background-repeat: repeat;">
                            ...
                            <div class="col-md-11" style="">
                              <div class="col-md-12 col-1 m-2" style="">
                                <h3 class="m-0 text-light" style="">
                                  <div class="row">
                                    <div class="border-light border-top border-bottom border-left my-2 ml-2" style="">
                                      ...
                                      <h4 class="ml-5 text-light">Giorno:</h4>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6" style=""><a class="btn text-light px-3 btn-secondary mx-5 mb-1">Cancella Partita</a></div>
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  <div class="row" style="">
                    <div class="col-md-12">
                      <div class="col-md-11 col-1 m-2" style="">
                        <h3 class="m-0 text-body" style="">
                          <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6" style=""><a class="btn text-light btn-secondary px-3 mx-5 mb-1">Cancella Partita</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-11 col-1 m-2" style="">
                        <h3 class="text-light m-0" style="">
                          <div class="row">
                            ...
                            <div class="col-md-5 col-lg-6 border-top border-bottom border-right border-light my-2 mr-2" style="">
                              <h4 class="text-light">{$idpartita}</h4>
                              <h4 class="text-light">{$numerocampo}</h4>
                              <h4 class="text-light">{$partecipanti}</h4>
                              <h4 class="text-light">{$giorno}</h4>
